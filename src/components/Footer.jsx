...
const Footer = () => {
  return (
    <footer className="w-full bg-[#ff6500] text-white py-6 mt-auto flex flex-col items-center px-4">
      <img src={logofooter} alt="Ndandani Footer Logo" className="h-12 w-auto mb-2 rounded-lg shadow" />
      <div className="font-bold text-xl mb-1 text-center">Ndandani</div>
      <div className="text-sm text-center">&copy; {new Date().getFullYear()} Ndandani. All rights reserved.</div>
